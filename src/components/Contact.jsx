...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 relative overflow-hidden bg-slate-50 border-t border-slate-200/80">
      {/* Ambient Glow */}
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-cyan-200/30 rounded-full blur-[140px] pointer-events-none"></div>
            ...
            <div className="bg-white border border-slate-200/80 p-6 rounded-3xl space-y-6 shadow-sm">
              ...
              <div className="space-y-4 text-xs">
                ...
                <div className="flex items-center gap-3 bg-slate-50 p-3.5 rounded-2xl border border-slate-200/80">
                  ...
                  <div>
                    <div className="text-slate-500 text-[10px] uppercase font-semibold">Institution</div>
              ...
              <div className="space-y-2 pt-2 border-t border-slate-200">
                <div className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Connect Online:</div>
                <div className="flex items-center gap-3">
                  <a
                    href={personalInfo.socials.github}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 py-2.5 rounded-xl bg-slate-100 border border-slate-200 hover:border-cyan-400 text-slate-700 hover:text-slate-900 text-xs font-semibold flex items-center justify-center gap-2 transition-all"
                  >
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 py-2.5 rounded-xl bg-slate-100 border border-slate-200 hover:border-blue-400 text-slate-700 hover:text-slate-900 text-xs font-semibold flex items-center justify-center gap-2 transition-all"
                  >
          ...
          <div className="lg:col-span-7">
            <form onSubmit={handleSubmit} className="bg-white p-8 rounded-3xl border border-slate-200/80 space-y-4 shadow-sm">
              ...
              <button
                ...
                className="w-full py-3.5 bg-gradient-to-r from-cyan-600 via-blue-600 to-indigo-600 hover:opacity-95 text-white font-bold text-xs rounded-xl flex items-center justify-center gap-2 shadow-lg shadow-cyan-600/20 transition-all disabled:opacity-50 cursor-pointer"
              >
                {status.submitting ? (
                  <>
